...
(module
  ...
  (data $d1)
  (data $d2 (i32.const 0))
  (data $d3 (i32.const 1) "a" "" "bcd")
  (data $d4 (offset (i32.const 0)))
  (data $d5 (offset (i32.const 0)) "" "a" "bc" "")
  (data $d6 (memory 0) (i32.const 0))
  (data $d7 (memory 0x0) (i32.const 1) "a" "" "bcd")
  (data $d8 (memory 0x000) (offset (i32.const 0)))
  (data $d9 (memory 0) (offset (i32.const 0)) "" "a" "bc" "")
  (data $d10 (memory $m) (i32.const 0))
  (data $d11 (memory $m) (i32.const 1) "a" "" "bcd")
  (data $d12 (memory $m) (offset (i32.const 0)))
  (data $d13 (memory $m) (offset (i32.const 0)) "" "a" "bc" "")
)
